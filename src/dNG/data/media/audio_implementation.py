...
class AudioImplementation(AbstractImplementation):
#
	"""
"AudioImplementation" provides methods to load a configured implementation
for audio handling and transformation.
...
:since:  v0.2.00
		...
		_return = Settings.get("pas_media_audio_implementation", "")
		if (_return == ""): raise ValueException("Media audio implementation class is not configured")
