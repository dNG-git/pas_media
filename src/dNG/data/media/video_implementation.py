...
class VideoImplementation(AbstractImplementation):
    """
"VideoImplementation" provides methods to load a configured implementation
for video handling and transformation.
